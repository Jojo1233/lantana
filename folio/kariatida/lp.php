		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="profile-wrapp">
					<div class="ab-profile-head">
						<span>Профиль</span>
					</div>
					<div class="ab-profile-greeting">
						<img src="img/ab-kr.png" alt="">
						<span>Поздравляем с Днем Рождения, Иван Иванович!</span>
					</div>
					<div class="ab-profile-img">
						<img src="img/face-pro.png" alt="">
					</div>
					<div class="ab-profile-info">
						<div class="ab-first-pro">
					...
					<div class="ab-comment">
						<span>Для изменения данных профиля напишите, пожалуйста, письмо менеджеру по договору</span>
					</div>
					<div class="but-message">
						<a href="#" class="button-2">написать сообщение</a>
					</div>
				</div>
			</div>
		</div>
